...
class AlertEngine:
    ...
    def _detection_to_alert(self, detection: Any) -> Alert:
        ...
        alert.flow_id = str(detection_dict.get("flow_id")) if detection_dict.get("flow_id") is not None else (
            str(detection_dict.get("flow_ids")[0]) if detection_dict.get("flow_ids") else None
        )
    ...
    def _get_alert_key(self, alert: Alert) -> str:
        ...
        parts=[
            ...
            str(alert.flow_id or ""), str(alert.window_id or ""),
